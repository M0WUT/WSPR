...
class Si5351
{
	public:
		...
		const int GPS_ENABLED = 0xDEADBEEF;
	...
	private:
		...
		const int Si5351_ADDRESS = 0b1100000;
		const int OUTPUT_ENABLE_REG = 3;
		const int ALL_CLOCKS_DISABLED = 0xFF;
		const int PLL_REG = 15;
		const int INPUT_DIV_1 = 0;
		const int INPUT_DIV_2 = 64;
		const int INPUT_DIV_4 = 128;
		const int CLOCK_POWER_DOWN = 0x80;
		const int XTAL_REG = 183;
};
